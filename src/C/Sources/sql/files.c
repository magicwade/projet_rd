#include "../../Headers/sql/files.h"
void get_all_files_by_user_id(PGconn* conn,int user_id,PGresult* res){
//	PGresult *result;	
	char rsql[100];
	sprintf(rsql, "Select * from files where user_id = %d;",user_id);
	res = PQexec(conn,rsql);
